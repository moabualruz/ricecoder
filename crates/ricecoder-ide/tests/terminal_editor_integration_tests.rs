...
fn test_vim_config_custom_keybindings() {
    ...
    config.keybindings.insert("completion".to_string(), "<C-x><C-o>".to_string());
    config.keybindings.insert("hover".to_string(), "K".to_string());
    config.keybindings.insert("goto_definition".to_string(), "<C-]>".to_string());
...
fn test_emacs_config_custom_keybindings() {
    ...
    config.keybindings.insert("completion".to_string(), "M-x completion-at-point".to_string());
    config.keybindings.insert("hover".to_string(), "C-c C-h".to_string());
    config.keybindings.insert("goto_definition".to_string(), "C-c C-d".to_string());
    
    assert_eq!(config.keybindings.len(), 3);
    assert_eq!(config.keybindings.get("completion").unwrap(), "M-x completion-at-point");
    assert_eq!(config.keybindings.get("hover").unwrap(), "C-c C-h");
    assert_eq!(config.keybindings.get("goto_definition").unwrap(), "C-c C-d");
}
