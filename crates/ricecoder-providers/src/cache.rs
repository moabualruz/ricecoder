...
mod tests {
    ...
    #[test]
    fn test_cache_set_and_get() -> ProviderResult<()> {
    ...
    #[test]
    fn test_cache_miss() -> ProviderResult<()> {
        let temp_dir = TempDir::new().unwrap();
        let cache = ProviderCache::new(temp_dir.path(), 3600)?;
    ...
    #[test]
    fn test_cache_invalidate() -> ProviderResult<()> {
        let temp_dir = TempDir::new().unwrap();
        let cache = ProviderCache::new(temp_dir.path(), 3600)?;
    ...
    #[test]
    fn test_cache_clear() -> ProviderResult<()> {
        let temp_dir = TempDir::new().unwrap();
        let cache = ProviderCache::new(temp_dir.path(), 3600)?;
    ...
    #[test]
    fn test_different_requests_different_cache() -> ProviderResult<()> {
        let temp_dir = TempDir::new().unwrap();
        let cache = ProviderCache::new(temp_dir.path(), 3600)?;
