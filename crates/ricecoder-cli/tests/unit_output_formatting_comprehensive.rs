...
fn test_output_formatting_idempotence_code() {
    ...
    assert_eq!(formatted1, formatted2, "Code formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_code_block() {
    ...
    assert_eq!(formatted1, formatted2, "Code block formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_prompt() {
    ...
    assert_eq!(formatted1, formatted2, "Prompt formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_header() {
    ...
    assert_eq!(formatted1, formatted2, "Header formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_section() {
    ...
    assert_eq!(formatted1, formatted2, "Section formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_list_item() {
    ...
    assert_eq!(formatted1, formatted2, "List item formatting should be idempotent");
}
...
fn test_output_formatting_idempotence_key_value() {
    ...
    assert_eq!(formatted1, formatted2, "Key-value formatting should be idempotent");
}
