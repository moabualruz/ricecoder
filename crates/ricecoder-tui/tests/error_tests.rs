...
mod tests {
    ...
    fn test_tool_error_display() {
        ...
        assert!(err
            .to_string()
            .contains("Tool execution failed: test_tool - failed"));
    }
}
