...
fn theme_name_strategy() -> impl Strategy<Value = String> {
    prop_oneof![
        ...
        Just("catppuccin-latte".to_string()),
        Just("catppuccin-frappe".to_string()),
        Just("catppuccin-macchiato".to_string()),
        Just("catppuccin-mocha".to_string()),
        Just("tokyo-night-storm".to_string()),
        Just("tokyo-night-moon".to_string()),
        Just("tokyo-night-day".to_string()),
        Just("tokyo-night-night".to_string()),
        Just("gruvbox-light".to_string()),
        Just("gruvbox-dark".to_string()),
        Just("solarized-light".to_string()),
        Just("solarized-dark".to_string()),
        Just("everforest".to_string()),
        Just("kanagawa".to_string()),
        Just("rose-pine".to_string()),
        Just("synthwave".to_string()),
        Just("material".to_string()),
        Just("one-dark".to_string()),
        Just("one-light".to_string()),
        Just("palenight".to_string()),
        Just("aura".to_string()),
        Just("ayu".to_string()),
    ]
}
